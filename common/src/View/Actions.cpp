...
std::vector<std::unique_ptr<Action>> ActionManager::createTagActions(
  ...
  for (const auto& tag : tags) {
    result.push_back(makeAction(
      ...
      QObject::tr("Toggle %1 visible").arg(QString::fromStdString(tag.name())), ActionContext::Any,
...
void ActionManager::resetAllKeySequences() const {
  ...
  auto actionVisitor = [](const Action& action) {
    action.resetKeySequence();
  };
...
void ActionManager::createViewActions() {
  ...
  createAction(
    ...
    QObject::tr("Toggle Show Entity Classnames"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShowEntityClassnames();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    ...
    QObject::tr("Toggle Show Group Bounds"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShowGroupBounds();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    ...
    QObject::tr("Toggle Show Brush Entity Bounds"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
  ...
  createAction(
    ...
    QObject::tr("Toggle Show Point Entity Bounds"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
  ...
  createAction(
    ...
    QObject::tr("Toggle Show Point Entities"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShowPointEntities();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    ...
    QObject::tr("Toggle Show Point Entity Models"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
  ...
  createAction(
    ...
    QObject::tr("Toggle Show Brushes"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShowBrushes();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    IO::Path("Controls/Map view/View Filter > Show textures"), QObject::tr("Show Textures"),
    ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->showTextures();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    IO::Path("Controls/Map view/View Filter > Hide textures"), QObject::tr("Hide Textures"),
    ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->hideTextures();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    IO::Path("Controls/Map view/View Filter > Hide faces"), QObject::tr("Hide Faces"),
    ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->hideFaces();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    IO::Path("Controls/Map view/View Filter > Shade faces"), QObject::tr("Toggle Shade Faces"),
    ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShadeFaces();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    IO::Path("Controls/Map view/View Filter > Use fog"), QObject::tr("Toggle Show Fog"),
    ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShowFog();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    IO::Path("Controls/Map view/View Filter > Show edges"), QObject::tr("Toggle Show Edges"),
    ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->toggleShowEdges();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    ...
    QObject::tr("Show All Entity Links"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->showAllEntityLinks();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  createAction(
    ...
    QObject::tr("Show Transitively Selected Entity Links"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
  ...
  createAction(
    ...
    QObject::tr("Show Directly Selected Entity Links"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
  ...
  createAction(
    ...
    QObject::tr("Hide All Entity Links"), ActionContext::Any, QKeySequence(),
    [](ActionExecutionContext& context) {
      context.view()->hideAllEntityLinks();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  ...
  /* ========== Misc Actions ========== */
  createAction(
    IO::Path("Controls/Map view/Cycle map view"), QObject::tr("Cycle View"), ActionContext::Any,
    QKeySequence(Qt::Key_Space),
    [](ActionExecutionContext& context) {
      context.view()->cycleMapView();
    },
    [](ActionExecutionContext& context) {
      return context.hasDocument();
    });
  ...
  createAction(
    IO::Path("Controls/Map view/Cancel"), QObject::tr("Cancel"), ActionContext::Any,
...
void ActionManager::createFileMenu() {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/New"), QObject::tr("New Document"), QKeySequence::New,
    [](ActionExecutionContext&) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Open..."), QObject::tr("Open Document..."), QKeySequence::Open,
    [](ActionExecutionContext&) {
      auto& app = TrenchBroomApp::instance();
      app.openDocument();
    },
  ...
  fileMenu.addSeparator();
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Save"), QObject::tr("Save Document"), QKeySequence::Save,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Save as..."), QObject::tr("Save Document as..."), QKeySequence::SaveAs,
    [](ActionExecutionContext& context) {
  ...
  exportMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Export/Wavefront OBJ..."), QObject::tr("Wavefront OBJ..."), 0,
    [](ActionExecutionContext& context) {
  ...
  exportMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Export/Map..."), QObject::tr("Map..."), 0,
    [](ActionExecutionContext& context) {
    ...
    IO::Path(),
    QObject::tr(
      "Exports the current map to a .map file. Layers marked Omit From Export will be omitted.")));

  /* ========== File Menu (Associated Resources) ========== */
  fileMenu.addSeparator();
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Load Point File..."), QObject::tr("Load Point File..."), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Reload Point File"), QObject::tr("Reload Point File"), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Unload Point File"), QObject::tr("Unload Point File"), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addSeparator();
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Load Portal File..."), QObject::tr("Load Portal File..."), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Reload Portal File"), QObject::tr("Reload Portal File"), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Unload Portal File"), QObject::tr("Unload Portal File"), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addSeparator();
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Reload Texture Collections"), QObject::tr("Reload Texture Collections"),
    Qt::Key_F5,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Reload Entity Definitions"), QObject::tr("Reload Entity Definitions"),
    Qt::Key_F6,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addSeparator();
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Revert"), QObject::tr("Revert Document"), 0,
    [](ActionExecutionContext& context) {
  ...
  fileMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Close"), QObject::tr("Close Document"), QKeySequence::Close,
    [](ActionExecutionContext& context) {
...
void ActionManager::createEditMenu() { /* ========== Edit Menu ========== */
  ...
  editMenu.addItem(
    createMenuAction(
      IO::Path("Menu/Edit/Undo"), QObject::tr("Undo"), QKeySequence::Undo,
      [](ActionExecutionContext& context) {
        context.frame()->undo();
      },
      [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(
    createMenuAction(
      IO::Path("Menu/Edit/Redo"), QObject::tr("Redo"), QKeySequence::Redo,
      [](ActionExecutionContext& context) {
        context.frame()->redo();
      },
      [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Repeat"), QObject::tr("Repeat Last Commands"), Qt::CTRL + Qt::Key_R,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Clear Repeatable Commands"), QObject::tr("Clear Repeatable Commands"),
  ...
  editMenu.addItem(
    createMenuAction(
      IO::Path("Menu/Edit/Cut"), QObject::tr("Cut"), QKeySequence::Cut,
      [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(
    createMenuAction(
      IO::Path("Menu/Edit/Copy"), QObject::tr("Copy"), QKeySequence::Copy,
      [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(
    createMenuAction(
      IO::Path("Menu/Edit/Paste"), QObject::tr("Paste"), QKeySequence::Paste,
      [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(
    createMenuAction(
      IO::Path("Menu/Edit/Paste at Original Position"), QObject::tr("Paste at Original Position"),
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Duplicate"), QObject::tr("Duplicate"), Qt::CTRL + Qt::Key_D,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Delete"), QObject::tr("Delete"), ActionContext::Any,
    QKeySequence(
#ifdef __APPLE__
      Qt::Key_Backspace
#else
  ...
  editMenu.addSeparator();
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Select All"), QObject::tr("Select All"), QKeySequence::SelectAll,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Select Siblings"), QObject::tr("Select Siblings"), Qt::CTRL + Qt::Key_B,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Select Touching"), QObject::tr("Select Touching"), Qt::CTRL + Qt::Key_T,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Select Inside"), QObject::tr("Select Inside"), Qt::CTRL + Qt::Key_E,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Select Tall"), QObject::tr("Select Tall"), ActionContext::Any,
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Select by Line Number"), QObject::tr("Select by Line Number..."), 0,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Select Inverse"), QObject::tr("Select Inverse"), ActionContext::Any,
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Select None"), QObject::tr("Select None"), ActionContext::Any,
  ...
  editMenu.addSeparator();
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Group"), QObject::tr("Group Selected Objects"), ActionContext::Any,
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Ungroup"), QObject::tr("Ungroup Selected Objects"),
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Create Linked Duplicate"), QObject::tr("Create Linked Duplicate"),
    ActionContext::Any, QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_D),
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Select Linked Groups"), QObject::tr("Select Linked Groups"),
    ActionContext::Any, 0,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Separate Linked Groups"), QObject::tr("Separate Selected Groups"),
    ActionContext::Any, 0,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createAction(
    IO::Path("Menu/Edit/Clear Protected Properties"), QObject::tr("Clear Protected Properties"),
    ActionContext::Any, 0,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Brush Tool"), QObject::tr("Brush Tool"), Qt::Key_B,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Clip Tool"), QObject::tr("Clip Tool"), Qt::Key_C,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Rotate Tool"), QObject::tr("Rotate Tool"), Qt::Key_R,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Scale Tool"), QObject::tr("Scale Tool"), Qt::Key_T,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Shear Tool"), QObject::tr("Shear Tool"), Qt::Key_G,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Vertex Tool"), QObject::tr("Vertex Tool"), Qt::Key_V,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Edge Tool"), QObject::tr("Edge Tool"), Qt::Key_E,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Tools/Face Tool"), QObject::tr("Face Tool"), Qt::Key_F,
    [](ActionExecutionContext& context) {
  ...
  toolMenu.addItem(createMenuAction(
    IO::Path("Controls/Map view/Deactivate current tool"), QObject::tr("Deactivate Current Tool"),
  ...
  csgMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/CSG/Convex Merge"), QObject::tr("Convex Merge"), Qt::CTRL + Qt::Key_J,
    [](ActionExecutionContext& context) {
  ...
  csgMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/CSG/Subtract"), QObject::tr("Subtract"), Qt::CTRL + Qt::Key_K,
    [](ActionExecutionContext& context) {
  ...
  csgMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/CSG/Hollow"), QObject::tr("Hollow"), Qt::CTRL + Qt::SHIFT + Qt::Key_K,
    [](ActionExecutionContext& context) {
  ...
  csgMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/CSG/Intersect"), QObject::tr("Intersect"), Qt::CTRL + Qt::Key_L,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addSeparator();
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Snap Vertices to Integer"), QObject::tr("Snap Vertices to Integer"),
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Snap Vertices to Grid"), QObject::tr("Snap Vertices to Grid"),
  ...
  editMenu.addSeparator();
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Texture Lock"), QObject::tr("Texture Lock"), 0,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/UV Lock"), QObject::tr("UV Lock"), Qt::Key_U,
    [](ActionExecutionContext& context) {
  ...
  editMenu.addSeparator();
  editMenu.addItem(createMenuAction(
    IO::Path("Menu/Edit/Replace Texture..."), QObject::tr("Replace Texture..."), 0,
    [](ActionExecutionContext& context) {
...
void ActionManager::createViewMenu() {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Show Grid"), QObject::tr("Show Grid"), Qt::Key_0,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Snap to Grid"), QObject::tr("Snap to Grid"), Qt::ALT + Qt::Key_0,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Increase Grid Size"), QObject::tr("Increase Grid Size"), Qt::Key_Plus,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Decrease Grid Size"), QObject::tr("Decrease Grid Size"), Qt::Key_Minus,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 0.125"), QObject::tr("Set Grid Size 0.125"), 0,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 0.25"), QObject::tr("Set Grid Size 0.25"), 0,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 0.5"), QObject::tr("Set Grid Size 0.5"), 0,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 1"), QObject::tr("Set Grid Size 1"), Qt::Key_1,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 2"), QObject::tr("Set Grid Size 2"), Qt::Key_2,
    [](ActionExecutionContext& context) {
      context.frame()->setGridSize(1);
    },
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 4"), QObject::tr("Set Grid Size 4"), Qt::Key_3,
    [](ActionExecutionContext& context) {
      context.frame()->setGridSize(2);
    },
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 8"), QObject::tr("Set Grid Size 8"), Qt::Key_4,
    [](ActionExecutionContext& context) {
      context.frame()->setGridSize(3);
    },
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 16"), QObject::tr("Set Grid Size 16"), Qt::Key_5,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 32"), QObject::tr("Set Grid Size 32"), Qt::Key_6,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 64"), QObject::tr("Set Grid Size 64"), Qt::Key_7,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 128"), QObject::tr("Set Grid Size 128"), Qt::Key_8,
    [](ActionExecutionContext& context) {
  ...
  gridMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Grid/Set Grid Size 256"), QObject::tr("Set Grid Size 256"), Qt::Key_9,
    [](ActionExecutionContext& context) {
  ...
  cameraMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Camera/Move to Next Point"), QObject::tr("Move Camera to Next Point"),
    Qt::Key_Period,
    [](ActionExecutionContext& context) {
  ...
  cameraMenu.addItem(createMenuAction(
    ...
    QObject::tr("Move Camera to Previous Point"), Qt::Key_Comma,
    [](ActionExecutionContext& context) {
  ...
  cameraMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Camera/Focus on Selection"), QObject::tr("Focus Camera on Selection"),
    Qt::CTRL + Qt::Key_U,
    [](ActionExecutionContext& context) {
  ...
  cameraMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Camera/Move Camera to..."), QObject::tr("Move Camera to..."), 0,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Isolate"), QObject::tr("Isolate Selection"), Qt::CTRL + Qt::Key_I,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Hide"), QObject::tr("Hide Selection"), Qt::CTRL + Qt::ALT + Qt::Key_I,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Show All"), QObject::tr("Show All"), Qt::CTRL + Qt::SHIFT + Qt::Key_I,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addSeparator();
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Switch to Map Inspector"), QObject::tr("Show Map Inspector"),
    Qt::CTRL + Qt::Key_1,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Switch to Entity Inspector"), QObject::tr("Show Entity Inspector"),
    Qt::CTRL + Qt::Key_2,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Switch to Face Inspector"), QObject::tr("Show Face Inspector"),
    Qt::CTRL + Qt::Key_3,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addSeparator();
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Toggle Toolbar"), QObject::tr("Toggle Toolbar"),
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Toggle Info Panel"), QObject::tr("Toggle Info Panel"), Qt::CTRL + Qt::Key_4,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Toggle Inspector"), QObject::tr("Toggle Inspector"), Qt::CTRL + Qt::Key_5,
    [](ActionExecutionContext& context) {
  ...
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/View/Maximize Current View"), QObject::tr("Maximize Current View"),
#ifdef Q_OS_MACOS
  ...
  viewMenu.addSeparator();
  viewMenu.addItem(createMenuAction(
    IO::Path("Menu/File/Preferences..."), QObject::tr("Preferences..."), QKeySequence::Preferences,
    [](ActionExecutionContext&) {
      auto& app = TrenchBroomApp::instance();
      app.showPreferences();
    },
...
void ActionManager::createRunMenu() {
  ...
  runMenu.addItem(createMenuAction(
    IO::Path("Menu/Run/Compile..."), QObject::tr("Compile Map..."), 0,
    [](ActionExecutionContext& context) {
  ...
  runMenu.addItem(createMenuAction(
    IO::Path("Menu/Run/Launch..."), QObject::tr("Launch Engine..."), 0,
    [](ActionExecutionContext& context) {
...
void ActionManager::createDebugMenu() {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Print Vertices"), QObject::tr("Print Vertices to Console"), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Create Brush..."), QObject::tr("Create Brush..."), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Create Cube..."), QObject::tr("Create Cube..."), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Clip Brush..."), QObject::tr("Clip Brush..."), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Crash..."), QObject::tr("Crash..."), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    ...
    QObject::tr("Throw Exception During Command"), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Show Crash Report Dialog"), QObject::tr("Show Crash Report Dialog..."), 0,
    [](ActionExecutionContext&) {
      auto& app = TrenchBroomApp::instance();
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Set Window Size..."), QObject::tr("Set Window Size..."), 0,
    [](ActionExecutionContext& context) {
  ...
  debugMenu.addItem(createMenuAction(
    IO::Path("Menu/Debug/Show Palette..."), QObject::tr("Show Palette..."), 0,
    [](ActionExecutionContext& context) {
...
void ActionManager::createHelpMenu() {
  ...
  helpMenu.addItem(createAction(
    IO::Path("Menu/Help/TrenchBroom Manual"), QObject::tr("TrenchBroom Manual"), ActionContext::Any,
